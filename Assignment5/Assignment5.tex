...
\begin{solution}
\begin{enumerate}
    \item From \eqref{eq3} we get 
        \begin{align*}
        E\brak{\theta|X} = \frac{S+\frac{1}{2}}{n+1} 
        \end{align*}
        $\implies$ for $ E\brak{\theta|X}$ to exist, 
        \begin{align*}
            n\neq-1
        \end{align*}
        ...
        \begin{align*}
            n>1
        \end{align*}
         $\implies E\brak{\theta|X}$ exists.\\
         $\therefore$ Option 2 is correct and option 1 is incorrect.
    \item From \eqref{eq4} we get 
        \begin{align*}
            E\brak{\theta|X}>\, \text{MLE}\\
        \end{align*}
        when
        \begin{align*}
            n>2\,S
        \end{align*}
        $\implies E\brak{\theta|X}>\, $MLE for some values of S.\\
