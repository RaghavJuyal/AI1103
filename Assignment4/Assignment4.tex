...
\begin{align}
    S_n =  S_0\times P^n
\end{align}
To get a win on the third trial we need the $(1,2)^{th}$ position of $S_2$.
\begin{align}
    S_2 &= S_0\times P^2 \nonumber\\
    &= \left[
\begin{array}{c c}
\frac{1}{216} &\frac{215}{216}
\end{array}
\right]
\end{align}\\
The $(1,2)^{th}$ position of $S_2$ includes the probability of getting a win on the third trial if the second trial is also a win. To find the required probability we have to subtract the $(1,2)^{th}$ position of $S_1$ from $(1,2)^{th}$ position of $S_2$.
\begin{align}
    S_1 &= S_0\times P \nonumber\\
    &= \left[
\begin{array}{c c}
\frac{1}{36} &\frac{35}{36} 
\end{array}
\right]\\
\end{align}
